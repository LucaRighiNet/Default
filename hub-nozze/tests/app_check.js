...
function viewGuests(){
  ...
  Object.keys(hh).sort().forEach(name=>{
    // "Senza nucleo" raccoglie persone di entrambi i lati: va spezzato per lato.
    // I nuclei veri mostrano il lato solo se è uniforme (altrimenti "lati misti").
    const groups=[];
    if(name==="Senza nucleo"){
