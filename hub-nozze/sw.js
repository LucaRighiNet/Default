...
const CACHE = "hub-nozze-v71"; // bump: scadenzario decisioni personalizzabile (mesi/data manuale/avvisi/nascondi per categoria)
...
self.addEventListener("fetch", e => {
  ...
  // cross-origin (es. API meteo/cloud): passa al browser, MAI cache-first —
  // altrimenti la prima risposta resterebbe congelata fino al bump di CACHE.
